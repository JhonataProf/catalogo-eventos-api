...
import { CreatePontoTuristicoUseCase } from "../../../application/use-cases/create-ponto-turistico.usecase";

export class CreatePontoTuristicoController implements Controller {
  constructor(private readonly useCase: CreatePontoTuristicoUseCase) {}
  ...
  async handle(req: HttpRequest): Promise<HttpResponse> {
    ...
    try {
      ...
      return created(
        resource(data, pontoTuristicoLinks(createdEntity.id), { version: "1.0.0" })
      );
    } catch (error) {
